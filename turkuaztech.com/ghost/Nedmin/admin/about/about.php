...
$about_al = $db->query('SELECT * FROM wp_about');

$about_al->execute(array());

$rows = $about_al->fetchAll(PDO::FETCH_ASSOC);
...
<div class="about-box-area">
	...
	<div style="background-image: url('img/<?php echo $m['img'];?>');" class="about-box-right"></div>
     <?php } ?>
	<div class="about-box-btns">
		<a href="about_gncl.php?id=<?php echo $m['id'];?>">
...
<div class="admin-page-right-menu">
    ...
    <a href="about_kyt.php">
    <div class="about_add_btns">
    	<i class="fas fa-plus"></i>
    	<p>Biyografini Oluştur</p>
    </div>
    </a>
</div>
