...
<form action="mkl-kyt.php" method="post">
<div class="blog-ekl-box">
  <div style="width: 100%;height: auto;float: left;">
    <input type="text" required="" placeholder="Makale Title" name="bg_title">
  </div>
  <div style="width: 100%;height: auto;float: left;">
    <input type="text" required="" placeholder="Makale Tanımlaması" name="bg_description">
  </div>
	<div style="width: 100%;height: auto;float: left;">
		<div class="file_text">
		Kapak Resmi Yükle
		<input type="file" name="bg_kapak" />
		</div>
	</div>
	<div style="width: 100%;height: auto;float: left;">
		<input type="text" required="" placeholder="Başlık Giriniz" name="bg_baslik">
	</div>

	<div style="width: 100%;height: auto;float: left;">
		<input type="text" required="" placeholder="Özet Giriniz" name="bg_ozet">
	</div>
	<div style="width: 100%;height: auto;float: left;">
		<input type="number" required="" placeholder="Gün" name="bg_gun">
		<select required="" name="bg_ay">
			<option>Ay</option>
		...
		<input style="margin-left: 2%;width: 100px;font-size: 17px;" type="number" required="" placeholder="Yıl" name="bg_yil">
	    <input style="width: 200px;" type="text" required="" placeholder="Yazar İsmi" name="bg_yzr">
	</div>
	<div style="width: 100%;height: auto;float: left;margin-top: 15px;">
	<textarea name="editor1"></textarea>
		
	</div>
	 <input style="width: 200px;" type="text" required="" placeholder="Makale Kataloğu" name="bg_ktlg">
	<div style="width: 100%;height: auto;float: left;margin-top: 15px;">
