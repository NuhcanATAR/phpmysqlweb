...
<div class="message-box">
 ...
 <p><?php echo $row['bg_id']; ?></p>
 <p style="font-size:17px;"><?php echo $row['Ad_soyad']; ?></p>
 <p style="float:right;margin-right:4%;font-size:17px;"><?php echo $row['Eposta']; ?></p>
 </div>
 ...
 <div style="width:50%;height:auto;float:left;">
   <a href="yrm_sil.php?id=<?php echo $row['id'];?>"><button>Yorumu Sil</button><a>
 </div>
<div style="width:50%;height:auto;float:left;">
   <a href="yrm_ekle.php?id=<?php echo $row['id'];?>"><button>Yorumu Ekle</button><a>
 </div>
</div>
