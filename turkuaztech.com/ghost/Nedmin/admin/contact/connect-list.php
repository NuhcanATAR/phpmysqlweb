...
<div class="url_name_box">
  <table>
    <?php

     $url_list = $db->query('SELECT * FROM wp_contact_url');

     $url_list->execute(array());

     $row = $url_list->fetchAll(PDO::FETCH_ASSOC);
    ...
    <tr>
      <td>
        <i class="<?php echo $rows['icon_instagram']; ?>"></i>
      </td>
      <td>
        <p><?php echo $rows['url_instagram']; ?></p>
      </td>
      <td>
        <a href="url_update.php?id=<?php echo $rows['id']; ?>"><i style="color: rgb(55, 255, 0);" class="fas fa-pen"></i></a>
      </td>
    </tr>
    <tr>
      <td>
        <i class="<?php echo $rows['icon_twitter']; ?>"></i>
      </td>
      <td>
        <p><?php echo $rows['url_twitter']; ?></p>
      </td>
      <td>
        <a href="url_update.php?id=<?php echo $rows['id']; ?>"><i style="color: rgb(55, 255, 0);" class="fas fa-pen"></i></a>
      </td>
    ...
    <tr>
      <td>
        <i class="<?php echo $rows['icon_facebook']; ?>"></i>
      </td>
      <td>
        <p><?php echo $rows['url_facebook']; ?></p>
      </td>
      <td>
        <a href="url_update.php?id=<?php echo $rows['id']; ?>"><i style="color: rgb(55, 255, 0);" class="fas fa-pen"></i></a>
      </td>
    ...
    <tr>
      <td>
        <i class="<?php echo $rows['icon_mail']; ?>"></i>
      </td>
      <td>
        <p><?php echo $rows['url_mail']; ?></p>
      </td>
      <td>
        <a href="url_update.php?id=<?php echo $rows['id']; ?>"><i style="color: rgb(55, 255, 0);" class="fas fa-pen"></i></a>
      </td>
