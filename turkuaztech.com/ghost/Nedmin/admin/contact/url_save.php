...
<div class="update_url_input_box">

<ol style="list-style-type:none;">
  <li><input type="text" required="" placeholder="İnstagram Url" name="url_instagram"></li>
  <li><input type="text" required="" placeholder="İnstagram İcon"name="icon_instagram"></li>
  <li><input type="text" required="" placeholder="Facebook Url" name="url_facebook"></li>
  <li><input type="text" required="" placeholder="Facebook İcon"name="icon_facebook"></li>
  <li><input type="text" required="" placeholder="Twitter Url" name="url_twitter"></li>
  <li><input type="text" required="" placeholder="Twitter İcon"name="icon_twitter"></li>
  <li><input type="text" required="" placeholder="Mail Adres" name="url_mail"></li>
  <li><input type="text" required="" placeholder="Mail İcon"name="icon_mail"></li>

</ol>

 <div style="width:100%;height:auto;float:left;">
  <button style="margin-left:3%;">Url Adreslerini Güncelle</button>
 </div>
</div>
</form>
...
if($_POST){
   ...
   $icon_instagram = $_POST["icon_instagram"];
   $url_facebook   = $_POST["url_facebook"];
   $icon_facebook  = $_POST["icon_facebook"];
   $url_twitter    = $_POST["url_twitter"];
   $icon_twitter   = $_POST["icon_twitter"];
   $url_mail       = $_POST["url_mail"];
   $icon_mail      = $_POST["icon_mail"];

   $url_add = $db->prepare("INSERT into wp_contact_url set
   ...
   $url_control = $url_add->execute(array(
   ...
   if($url_control){
     echo '
     <script type="text/javascript">alert("URL Adresleri Eklendi");</script>
     ';
   }else{
     echo "Başarısız";
   }
