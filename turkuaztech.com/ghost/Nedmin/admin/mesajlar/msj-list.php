...
$msj_list = $db->query('SELECT * FROM wp_message');

$msj_list->execute(array());

$rows = $msj_list->fetchAll(PDO::FETCH_ASSOC);

foreach($rows as $row){

?>
<div class="message-box">
 <div class="message_user_mail_datetime_box">
 <i class="fas fa-user"></i>
 <p><?php echo $row['name']; ?></p>
 <p style="font-size:17px;"><?php echo $row['datetimee']; ?></p>
 <p style="float:right;margin-right:4%;font-size:17px;"><?php echo $row['mail']; ?></p>
 </div>
 ...
 <div style="width:100%;height:auto;float:left;">
   <a href="msj_sil.php?id=<?php echo $row['id'];?>"><button>Mesajı Sil</button><a>
 </div>
</div>
<?php } ?>
