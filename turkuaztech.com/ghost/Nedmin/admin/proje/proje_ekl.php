...
<form action="proje_kyt_ony.php" method="post">
<div class="proje_add_input_box">
  <div style="width:100%;height:auto;float:left;">
    <div class="file_text">
   	  Kapak Resmi Yükle
   	  <input type="file" name="pr_kapak" />
   	</div>
  </div>
  <div style="width:100%;height:auto;float:left;">
    <input type="text" required="" name="pr_baslik" placeholder="Proje İsmi"/>
  </div>
  <div style="width:100%;height:auto;float:left;">
    <input type="text" required="" name="pr_ozet" placeholder="Proje Özetiniz"/>
  </div>
  <div style="width:100%;height:auto;float:left;">
